...
export default function SocialShare({
  ...
  const handleInstagram = () => {
    navigator.clipboard.writeText(shareText).then(() => {
      toast.success('Texto copiado! Cole no Instagram ou onde preferir.');
    });
    setOpen(false);
  };
    ...
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        <Button
          variant="outline"
          size="sm"
          className="border-black/15 text-gray-600 font-semibold normal-case rounded-lg hover:border-[#1976d2] hover:text-[#1976d2] hover:bg-[#1976d2]/[0.04]"
        >
      ...
      <PopoverContent className="w-[280px] p-0" align="center" sideOffset={8}>
        <div className="p-4">
          ...
          {/* Preview */}
          <div className="bg-gray-100 rounded-lg p-3 mb-4 border border-border">
